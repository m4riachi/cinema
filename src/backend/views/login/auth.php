...
<head>
    ...
    <link href="<?php echo \src\Helper::base_url()?>assets/backend/assets/css/authentication/form-1.css" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <link rel="stylesheet" type="text/css" href="<?php echo \src\Helper::base_url()?>assets/backend/assets/css/forms/theme-checkbox-radio.css">
    <link rel="stylesheet" type="text/css" href="<?php echo \src\Helper::base_url()?>assets/backend/assets/css/forms/switches.css">
</head>
<body class="form">
        ...
        <div class="form-form-wrap">
            <div class="form-container">
                <div class="form-content">
                    <h1 class="">Connectez-vous à  <a href="index.html"><span class="brand-name">Cinema Memico </span></a></h1>
                    <form class="text-left" method="post" action="<?=\src\Helper::base_url() . 'backend/login/auth'?>">
                        <div class="form">
...
<script src="<?php echo \src\Helper::base_url()?>assets/backend/assets/js/authentication/form-1.js"></script>
