            ...
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="widget-content widget-content-area br-6">
                        <div class="col-lg-12">
                            <div class="col-lg-12">
                                <a href="<?php echo \src\Helper::base_url();?>backend/genre/create" class="btn btn-primary btn-rounded mb-2 float-right">
                            ...
                            <table id="zero-config" class="table table-hover" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 143px">
                                        <a href="<?php echo \src\Helper::base_url();?>backend/genre/edit/?id=<?=$data['id']?>" class="btn btn-primary" style="padding: 0.4375rem 0.55rem;" title="Modifier">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg>
                                        </a>
                                        <form action="<?=\src\Helper::base_url()?>backend/genre/delete" method="post" class="d-inline-block">
