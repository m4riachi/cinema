<div id="content" class="main-content">
    <form action="<?php echo \src\Helper::base_url();?>backend/admin/save"  id="form_submit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="widget-content widget-content-area br-6">
                        <div class="row w-100">
                            <div class="col-lg-4">
                                ...
                                <input name="username" value="<?=\src\Helper::showSession('username') ?>" type="text" class="form-control">
                            </div>
                            <div class="col-lg-4">
                                <label for="password">Mot de passe</label>
                                <input name="password" value="<?=\src\Helper::showSession('password') ?>" type="password" class="form-control">
                            </div>
